...
exports.forgotPassword = async (req, res) => {
  try {
    ...
    var message = `please click to below provided link for changing password. Note that the provided link will expire within 10 mins - localhost:3000/forgot-password/${resetToken}`;
...
exports.resetPassword = async (req, res) => {
  try {
    ...
    if (!user) {
      return res.status(400).json({
        status: "error",
        message: "token doesnt exist or has been expired!",
      });
    }
